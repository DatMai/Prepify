export const vi: Record<string, string> = {
  ...
  'journey.noteTitle': 'Toàn bộ nội dung ngày',
  'journey.noteHint': 'Đúng như trong Obsidian, chỉ đọc — gồm cả các mục con và khối recall.',
  'journey.noNote': 'Note hôm nay chưa có nội dung.',
  'journey.noteToggle': 'Mở hoặc thu gọn khối này',
