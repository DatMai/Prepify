export const vi: Record<string, string> = {
  ...
  'review.title': 'Ôn tập',
  'review.loading': 'Đang tải câu hỏi ôn tập…',
  ...
  'api.email_delivery_failed': 'Không thể gửi email lúc này. Vui lòng thử lại sau.',
  ...
  'journey.journalHint': 'Viết tiếng Anh.',
  ...
  'ql.start': 'Bắt đầu',
  'ql.loading': 'Đang tải nội dung môn…',
