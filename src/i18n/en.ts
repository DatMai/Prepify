export const en: Record<string, string> = {
  ...
  'review.title': 'Review',
  'review.loading': 'Loading review questions…',
  ...
  'api.email_delivery_failed': 'Email could not be delivered. Please try again later.',
  ...
  'ql.randomQ': 'Random {n}',
  'ql.start': 'Start',
  'ql.loading': 'Loading subject content…',
